...
import os
import re
from checkpoint_config import deconstruct_dir # type: ignore

def accuracy_plotter(dir_path):
    seed, criter, optim, sched, learning_rate, dim_list, grid_size, grid_min, grid_max, inv_denominator = deconstruct_dir(dir_path)
    ...
    plt.figtext(0.5, 0.001, 
                f'Model Hyperparams:\nSeed = {seed}, Criterion = {criter}, Optimizer = {optim}, Scheduler = {sched},\n'
